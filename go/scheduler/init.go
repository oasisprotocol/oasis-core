...
func New(ctx context.Context, reg registry.Backend, beacon beacon.Backend, service service.TendermintService) (api.Backend, error) {
	...
	case tendermint.BackendName:
		return tendermint.New(ctx, service)
	default:
