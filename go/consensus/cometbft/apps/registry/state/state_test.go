...
var (
	entitySigner     = memorySigner.NewTestSigner("consensus/cometbft/apps/registry/state: entity signer")
	nodeSigner       = memorySigner.NewTestSigner("consensus/cometbft/apps/registry/state: node signer")
	consensusSigner1 = memorySigner.NewTestSigner("consensus/cometbft/apps/registry/state: consensus signer 1")
	consensusSigner2 = memorySigner.NewTestSigner("consensus/cometbft/apps/registry/state: consensus signer 2")
	p2pSigner1       = memorySigner.NewTestSigner("consensus/cometbft/apps/registry/state: p2p signer 1")
	p2pSigner2       = memorySigner.NewTestSigner("consensus/cometbft/apps/registry/state: p2p signer 2")
	tlsSigner1       = memorySigner.NewTestSigner("consensus/cometbft/apps/registry/state: tls signer 1")
	tlsSigner2       = memorySigner.NewTestSigner("consensus/cometbft/apps/registry/state: tls signer 2")
)
...
func TestNodeUpdate(t *testing.T) {
	...
	consensusAddress := []byte(tmcrypto.PublicKeyToCometBFT(&n.Consensus.ID).Address())
	...
	newConsensusAddress := []byte(tmcrypto.PublicKeyToCometBFT(&newNode.Consensus.ID).Address())
