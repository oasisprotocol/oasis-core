...
func NewNode(
	...
	checkpointer, err := n.createCheckpointer(commonNode, localStorage)
	if err != nil {
...
func (n *Node) createCheckpointer(commonNode *committee.Node, localStorage storageApi.LocalBackend) (checkpoint.Checkpointer, error) {
