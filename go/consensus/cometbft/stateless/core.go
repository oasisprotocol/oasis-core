...
func (c *Core) GetBlock(ctx context.Context, height int64) (*consensusAPI.Block, error) {
	...
	if err = c.verifyBlock(blk, lb); err != nil {
		return nil, err
	}
...
func (c *Core) GetTransactions(ctx context.Context, height int64) ([][]byte, error) {
	...
	if err := c.verifyTransactions(txs, lb); err != nil {
		return nil, err
	}
...
func (c *Core) verifyBlock(blk *consensusAPI.Block, lb *cmttypes.LightBlock) error {
...
func (c *Core) verifyBlockResults(ctx context.Context, results *consensusAPI.BlockResults, lb *cmttypes.LightBlock) (x *api.BlockResultsMeta, err error) {
	...
	if err != nil || lastHeight <= lb.Height {
...
func (c *Core) verifyTransactions(txs [][]byte, lb *cmttypes.LightBlock) error {
