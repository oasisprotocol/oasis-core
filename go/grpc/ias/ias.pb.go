...
func (*GetSPIDInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5a09d1582de2ec30, []int{0}
}
...
func (m *GetSPIDInfoRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSPIDInfoRequest.Merge(m, src)
}
...
func (*GetSPIDInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5a09d1582de2ec30, []int{1}
}
...
func (m *GetSPIDInfoResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSPIDInfoResponse.Merge(m, src)
}
...
func (*VerifyEvidenceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5a09d1582de2ec30, []int{2}
}
...
func (m *VerifyEvidenceRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VerifyEvidenceRequest.Merge(m, src)
}
...
func (*VerifyEvidenceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5a09d1582de2ec30, []int{3}
}
...
func (m *VerifyEvidenceResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VerifyEvidenceResponse.Merge(m, src)
}
...
func (*GetSigRLRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5a09d1582de2ec30, []int{4}
}
...
func (m *GetSigRLRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSigRLRequest.Merge(m, src)
}
...
func (*GetSigRLResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5a09d1582de2ec30, []int{5}
}
...
func (m *GetSigRLResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSigRLResponse.Merge(m, src)
}
...
func init() { proto.RegisterFile("ias/ias.proto", fileDescriptor_5a09d1582de2ec30) }

var fileDescriptor_5a09d1582de2ec30 = []byte{
