...
oasis_worker_committee_transition_count | Counter | Number of committee transitions. | runtime | [worker/common/committee](https://github.com/oasisprotocol/oasis-core/tree/master/go/worker/common/committee/node.go)
