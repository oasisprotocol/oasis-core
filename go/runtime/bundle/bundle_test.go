...
func TestBundle(t *testing.T) {
	...
	t.Run("Open_WithManifestRewriter", func(t *testing.T) {
		bnd, err := Open(bundleFn, WithManifestRewriter(func(m *Manifest) {
			m.Name = "test-rewritten"
		}))
		require.NoError(t, err, "Open_WithManifestRewriter")
