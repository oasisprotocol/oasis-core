...
func (*SetEpochRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_838bd8cfb542250c, []int{0}
}
...
func (m *SetEpochRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetEpochRequest.Merge(m, src)
}
...
func (*SetEpochResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_838bd8cfb542250c, []int{1}
}
...
func (m *SetEpochResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetEpochResponse.Merge(m, src)
}
...
func (*WaitNodesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_838bd8cfb542250c, []int{2}
}
...
func (m *WaitNodesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WaitNodesRequest.Merge(m, src)
}
...
func (*WaitNodesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_838bd8cfb542250c, []int{3}
}
...
func (m *WaitNodesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WaitNodesResponse.Merge(m, src)
}
...
func init() { proto.RegisterFile("dummydebug/dummy_debug.proto", fileDescriptor_838bd8cfb542250c) }

var fileDescriptor_838bd8cfb542250c = []byte{
