...
# Branches to test.
pre_upgrade_git_branch="peternose/stable/22.2.x/backport-5265"
post_upgrade_git_branch="master"

# Working directories.
workdir=$PWD
pre_upgrade_datadir="/tmp/oasis-pre-upgrade"
post_upgrade_datadir="/tmp/oasis-post-upgrade"
...
echo "Downloading and building oasis-core..."
...
pre_upgrade_test_runner_binary="${workdir}/tests/upgrade/pre/oasis-test-upgrade"
post_upgrade_test_runner_binary="${workdir}/tests/upgrade/post/oasis-test-upgrade"
