...
func (rh *roflHostHandler) handleBundleManagement(ctx context.Context, rq *enclaverpc.Request) (interface{}, error) {
	...
	case rofl.MethodBundleWipeStorage:
		...
		return rh.handleBundleWipeStorage(ctx, &args)
...
func (rh *roflHostHandler) getBundleManagementLabels() map[string]string {
	return map[string]string{
		bundle.LabelOrigin: fmt.Sprintf("%s-%s", rh.parent.runtime.ID(), rh.id),
	}
}

func (rh *roflHostHandler) handleBundleWrite(ctx context.Context, rq *rofl.BundleWriteRequest) (*rofl.BundleWriteResponse, error) {
...
func (rh *roflHostHandler) handleBundleAdd(ctx context.Context, rq *rofl.BundleAddRequest) (*rofl.BundleAddResponse, error) {
	if err := rh.ensureComponentPermissions(runtimeConfig.PermissionBundleAdd); err != nil {
		return nil, err
	}
...
func (rh *roflHostHandler) handleBundleRemove(ctx context.Context, rq *rofl.BundleRemoveRequest) (*rofl.BundleRemoveResponse, error) {
...
func (rh *roflHostHandler) handleBundleWipeStorage(ctx context.Context, rq *rofl.BundleWipeStorageRequest) (*rofl.BundleWipeStorageResponse, error) {
	if err := rh.ensureComponentPermissions(runtimeConfig.PermissionBundleRemove); err != nil {
		return nil, err
	}
...
func (rh *roflHostHandler) handleBundleList(ctx context.Context, rq *rofl.BundleListRequest) (*rofl.BundleListResponse, error) {
	if err := rh.ensureComponentPermissions(runtimeConfig.PermissionBundleAdd); err != nil {
		return nil, err
	}
