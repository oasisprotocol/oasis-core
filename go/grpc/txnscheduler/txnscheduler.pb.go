...
func (*SubmitTxRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7dc2c51904f0b627, []int{0}
}
...
func (*SubmitTxResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7dc2c51904f0b627, []int{1}
}
...
func (*IsTransactionQueuedRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7dc2c51904f0b627, []int{2}
}
...
func (m *IsTransactionQueuedRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IsTransactionQueuedRequest.Merge(m, src)
}
...
func (*IsTransactionQueuedResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7dc2c51904f0b627, []int{3}
}
...
func (m *IsTransactionQueuedResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IsTransactionQueuedResponse.Merge(m, src)
}
...
func init() { proto.RegisterFile("txnscheduler/txnscheduler.proto", fileDescriptor_7dc2c51904f0b627) }

var fileDescriptor_7dc2c51904f0b627 = []byte{
