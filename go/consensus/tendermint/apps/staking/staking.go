...
func (app *stakingApplication) ExecuteTx(ctx *abci.Context, tx *transaction.Transaction) error {
	...
	case staking.MethodTransfer:
		...
		if err := fill2.Unmarshal(tx.Body, &xfer); err != nil {
			return err
		}
	...
	case staking.MethodBurn:
		...
		if err := fill2.Unmarshal(tx.Body, &burn); err != nil {
			return err
		}
	...
	case staking.MethodAddEscrow:
		...
		if err := fill2.Unmarshal(tx.Body, &escrow); err != nil {
			return err
		}
	...
	case staking.MethodReclaimEscrow:
		...
		if err := fill2.Unmarshal(tx.Body, &reclaim); err != nil {
			return err
		}
	...
	case staking.MethodAmendCommissionSchedule:
		...
		if err := fill2.Unmarshal(tx.Body, &amend); err != nil {
			return err
		}
