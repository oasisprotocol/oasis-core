...
func TestPebbleDbCheckpointer(t *testing.T) {
	t.Run("Basic", func(t *testing.T) {
		testCheckpointer(t, pebbledb.New, 0, 1, false)
	})
	t.Run("NonZeroEarliestVersion", func(t *testing.T) {
		testCheckpointer(t, pebbledb.New, 1000, 1, false)
	})
	t.Run("NonZeroEarliestInitialVersion", func(t *testing.T) {
		testCheckpointer(t, pebbledb.New, 100, 1, true)
	})
	t.Run("MaybeUnderflow", func(t *testing.T) {
		testCheckpointer(t, pebbledb.New, 5, 10, true)
	})
	t.Run("ForceCheckpoint", func(t *testing.T) {
		testCheckpointer(t, pebbledb.New, 0, 10, false)
	})
}
