...
// WithAutomaticEpochTransitions is an option for enabling automatic epoch transitions in the
// committee watcher. Committees will be updated whenever the scheduler elects new committees.
